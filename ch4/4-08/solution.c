...
/* ex 4-08 getch/ungetch single character pushback */

int bufc = 0; /* pushed back character */

/* getch: get a (possibly pushed back) character */
int getch(void)
{
    if (bufc) /* 0 indicates no pushed back character */
    {
        int tmp = bufc;
        bufc = 0; /* 'reset' pushed back character */
        return tmp;
    }
    else
    {
...
void ungetch(int c)
{
    if (bufc)
    {
        /* can only store a single pushed back character */
